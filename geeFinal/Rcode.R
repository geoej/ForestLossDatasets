...
for (i in c("Dec2010", "Dec2011", "Dec2012", "Dec2013", "Dec2014", "Dec2015", "Dec2016", "Dec2017", "Dec2018", "Dec2019", "Dec2020")){
  ...
  agriculture[i] <- sum(st_area(filter(TMF_all, .data[[i]] >= 3 & .data[[i]] < 4) %>% select(contains(i))))/1000000
  forest[i] <- sum(st_area(filter(TMF_all, .data[[i]] >= 1 & .data[[i]] < 2) %>% select(contains(i))))/1000000
